...
export interface ILeftData extends IStickTableRow {
  rowIndex: number;
  rowData;
...
export interface ICommonStickyGrid {
  ...
  */
  ...
  //
  //
  /* If undefined scrollbar reset only when change items */
  ...
  columns: IColumn[];
  /** Columns' ids to dememoize */
  columnsDememoized?: string[];
}
