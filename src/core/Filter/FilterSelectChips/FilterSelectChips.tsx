...
import { LabelMandatory } from "../../Field";
    ...
    >
      {!label ? null : (
        <Text
          ...
          children={<LabelMandatory label={label} mandatory={labelMandatory} />}
        />
      )}
      {!showFilterMandatory || !thereAreMandatory ? null : (
        <FacetToggle
          color={color}
