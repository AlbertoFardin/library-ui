...
import FilterSelectChips from "./FilterSelectChips";
import { IFilterSelectChips } from "./interfaces";
import { IMngChipValue, IMngChipGroup } from "../../../layout/WindowMngSets";
...
export default {
  title: "core/Filter/FilterSelectChips",
  component: FilterSelectChips,
  args: {
    style: { margin: "50px 25px" },
    label: "FilterSelectChips",
    chipsSelected: ["zucchina"],
    chipsValues,
    chipsGroups,
    onChange: action("onChange"),
  } as IFilterSelectChips,
};

const DemoStory = () => <DemoCmp />;
export const Demo = DemoStory.bind({});

const Story = (args) => <FilterSelectChips {...args} />;
